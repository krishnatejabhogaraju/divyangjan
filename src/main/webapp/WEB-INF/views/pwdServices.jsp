                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control" id="jd" placeholder="Job Title">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Organization Name">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Experience required(yrs)</label>
                                                    <select class="form-control" id="select">
                                                            <option>1</option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="1" placeholder="Ex: typehiger,msexcel,"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <label for="exampleInputEmail1">Age</label></div>
                                                        <div class="col-md-5">
                                                            <input type="number" min="10" max="100" class="form-control" id="exampleInputEmail1" placeholder="MIN"></div>
                                                        <div class="col-md-5">
                                                            <input type="number" min="10" max="100" class="form-control" id="exampleInputEmail1" placeholder="MAX">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="2" placeholder="Enter Job Description"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Additional Notes</label>
                                                    <textarea class="form-control" rows="2" placeholder="Enter Additional Notes"></textarea>
                                                </div>
                                            </div>
                                        </div>
