        ...
        <div class="boxed">
            ...
            <!-- <header class="main-header">
                <div class="container">
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="active">Skill Training & Coaching </li>
                    </ol>
                </div>
            </header> -->
            <header class="page-title-header-skill">
                <div class="container">
                    <div class="service-header-cnt">
                        <div class="service-img-icon">
                            <img src="resources/assets/img/services/banner-icon/skill.png" class="img-responsive" />
                        </div>
                        <div class="serive-name">Skill Training & Coaching
                        </div>
                    </div>
                </div>
            </header>
            ...
            <div class="container content-container-services">
                <section class="margin-bottom">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="right-line">Skill Training & Coaching </h2>
                        </div>
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-plus-link">
                                        <a data-toggle="collapse" data-parent="#accordioncc" href="#cc2" class="collapsed" aria-expanded="false">
                                                Information on Training centres / Institutions for PwDs  
                                        </a>
                                    </div>
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-plus-link">
                                        <a data-toggle="collapse" data-parent="#accordioncc" href="#cc3" class="collapsed" aria-expanded="false">
                                                Identification of training based on the job roles.
                                        </a>
                                    </div>
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-plus-link">
                                        <a data-toggle="collapse" data-parent="#accordioncc" href="#cc4" class="collapsed" aria-expanded="false">
                                                Training Courses, Fees & Entitlements
                                        </a>
                                    </div>
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-plus-link">
                                        <a data-toggle="collapse" data-parent="#accordioncc" href="#cc5" class="collapsed" aria-expanded="false">
                                                Procedures to apply for trainings 
                                        </a>
                                    </div>
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-plus-link">
                                        <a data-toggle="collapse" data-parent="#accordioncc" href="#cc6" class="collapsed" aria-expanded="false">
                                                Notifications on on-going trainings 
                                        </a>
                                    </div>
