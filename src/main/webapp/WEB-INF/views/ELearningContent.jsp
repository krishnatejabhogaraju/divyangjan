        ...
        <div class="boxed">
            ...
            <!-- <header class="main-header">
                <div class="container">
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="active">E-Learning Content </li>
                    </ol>
                </div>
            </header> -->
            <header class="page-title-header-elearn">
                <div class="container">
                    <div class="service-header-cnt">
                        <div class="service-img-icon">
                            <img src="resources/assets/img/services/banner-icon/elearn.png" class="img-responsive" />
                        </div>
                        <div class="serive-name">E-Learning Content
                        </div>
                    </div>
                </div>
            </header>
            ...
            <div class="container content-container-services">
                <section class="margin-bottom">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="right-line">E-Learning Content </h2>
                        </div>
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-plus-link">
                                        <a data-toggle="collapse" data-parent="#accordioncc" href="#cc1" aria-expanded="false" class="collapsed">
                                                Easily accessible e-content for PwDs in schools & colleges
                                        </a>
                                    </div>
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-plus-link">
                                        <a data-toggle="collapse" data-parent="#accordioncc" href="#cc3" class="collapsed" aria-expanded="false">
                                                E-learning material for self- paced learning 
                                        </a>
                                    </div>
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-plus-link">
                                        <a data-toggle="collapse" data-parent="#accordioncc" href="#cc7" class="collapsed" aria-expanded="false">
                                                Interactive session that helps PwD to find their abilities & levels on Physical, Psychological, Technical, Reasoning, Aptitude, Interests etc. 
                                        </a>
                                    </div>
