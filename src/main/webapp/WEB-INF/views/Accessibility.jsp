...
<body>
    <div class="sb-site-container">
        <div class="boxed">
            ...
            <header class="page-title-header-accbility">
                <div class="container">
                    <div class="service-header-cnt">
                        <div class="service-img-icon">
                            <img src="resources/assets/img/services/banner-icon/accbility.png" class="img-responsive" />
                        </div>
                        <div class="serive-name">Accessibility</div>
                    </div>
                </div>
            </header>
            ...
            <div class="container content-container-services">
                <section class="margin-bottom">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="right-line">Accessibility </h2>
                        </div>
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-plus-link">
                                        <a data-toggle="collapse" data-parent="#accordioncc" href="#cc1" aria-expanded="false" class="collapsed">
                                            Physical Accessibility – List approved and accessible companies, institutes hospitals etc
                                        </a>
                                    </div>
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-plus-link">
                                        <a data-toggle="collapse" data-parent="#accordioncc" href="#cc2" class="collapsed" aria-expanded="false">
                                            Accessible Tourism & Travel sites that are PwD Friendly. 
                                        </a>
                                    </div>
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-plus-link">
                                        <a data-toggle="collapse" data-parent="#accordioncc" href="#cc3" class="collapsed" aria-expanded="false">
                                            Digital accessibility –Websites 
                                        </a>
                                    </div>
