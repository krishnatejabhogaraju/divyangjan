        ...
        <div class="boxed">
            ...
            <!-- <header class="main-header">
                <div class="container">
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="active">PwD Entertainment </li>
                    </ol>
                </div>
            </header> -->
            <header class="page-title-header-entertainment">
                <div class="container">
                    <div class="service-header-cnt">
                        <div class="service-img-icon">
                            <img src="resources/assets/img/services/banner-icon/entertainment.png" class="img-responsive" />
                        </div>
                        <div class="serive-name">PWD Entertainment</div>
                    </div>
                </div>
            </header>
            ...
            <div class="container content-container-services">
                <section class="margin-bottom">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="right-line">PwD Entertainment </h2>
                        </div>
                    </div>
                    <!-- row -->
                    <div class="row">
