        ...
        <div class="boxed">
            ...
            <!-- <header class="main-header">
                <div class="container">
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="active">Knowledge Bank  </li>
                    </ol>
                </div>
            </header> -->

            <header class="page-title-header-kwbank">
                <div class="container">
                    <div class="service-header-cnt">
                        <div class="service-img-icon">
                            <img src="resources/assets/img/services/banner-icon/kwbank.png" class="img-responsive" />
                        </div>
                        <div class="serive-name">Knowledge Bank</div>
                    </div>
                </div>
            </header>
            ...
            <div class="container content-container-services">
                <section class="margin-bottom">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="right-line">Knowledge Bank </h2>
                        </div>
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-plus-link">
                                        <a data-toggle="collapse" data-parent="#accordioncc" href="#cc2" class="collapsed" aria-expanded="false">
                                            About Disability & Disability Types
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-plus-link">
                                        <a data-toggle="collapse" data-parent="#accordioncc" href="#cc4" class="collapsed" aria-expanded="false">
                                            Various Government Programs for Disability  
                                        </a>
                                    </div>
