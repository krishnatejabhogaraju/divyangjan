    ...
    <div class="sb-site-container">
        <div class="boxed">
            ...
            <ul class="sidebar-nav animated fadeIn">
                   <li class="active"><a href="#"  class="collapsed" onclick="loadDataDiv('successStories')"><i class="fa fa-user" ></i> Success Stories</a></li>
                    <li><a href="#"  class="collapsed"  onclick="loadDataDiv('skillTraining')"><i class="fa fa-graduation-cap"></i> Skills &amp; Training</a></li>
                   <li><a href="#"  class="collapsed"><i class="fa fa-bank"></i> Employeement Jobs</a></li>
                   <li><a href="#"  class="collapsed"><i class="fa fa-suitcase"></i> Entrepreneurship</a></li>
                ...
                <li>
                    ...
                    <ul id="coll-comp" class="menu-submenu list-unstyled collapse">
                        ...
                        <li><a href="components_tooltip_popover.html"><i class="fa fa-arrow-circle-right"></i> Tooltip &amp; Popover</a></li>
                            ...
                            <div class="col-md-9 col-lg-9" id="dataDiv" style="min-height:350px ">
...
function loadDataDiv(repType)
{
  ...
  if(repType=="successStories")
  {
	  reptUrl="/divyangjan/laodSuccessStories";
	  
  }else if(repType=="skillTraining")
  {
	  reptUrl="/divyangjan/skillTraining";
  }
