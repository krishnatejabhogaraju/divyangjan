...
<div class="container-fluid content-container-services">
                <section class="margin-bottom">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="right-line"><!-- Admin User: BFMT --></h2>
                        </div>
            ...
            <ul class="sidebar-nav animated fadeIn">
              		<li><a href="#"  class="collapsed" onclick="loadDataDiv()"><i class="fa fa-bank"></i> Job Post</a></li>
                    <li><a href="#"  class="collapsed" ><i class="fa fa-graduation-cap"></i> Job Portal</a></li>
                   <li class="active"><a href="#"  class="collapsed" ><i class="fa fa-user" ></i> Matrimony Post</a></li>
                   <li><a href="#"  class="collapsed"  ><i class="fa fa-suitcase"></i>Skill &  Training</a></li>
                ...
                <li>
                    ...
                    <ul id="coll-comp" class="menu-submenu list-unstyled collapse">
                        ...
                        <li><a href="components_tooltip_popover.html"><i class="fa fa-arrow-circle-right"></i> Tooltip &amp; Popover</a></li>
                            ...
                            <div class="col-md-9 col-lg-9" id="dataDiv" style="min-height:500px ">
		...
		<!-- <div class="container content-container-services"  id="dataDiv"></div> -->
...
function loadDataDiv()
{
	...
	$("#dataDiv").html("<image src='resources/assets/img/preload.gif' style='margin-top:150px;margin-left:400px'>");
...
function validateForm() {
	...
	var dataString = $('form[name=jobForm]').serialize();
	...
	if (experienceRequired == "0") {
		...
		$("#experienceRequired").focus();
		return false;
	}

	if (skillSets == "") {
		alert('Please Enter Skill Sets');
		$("#skillSets").focus();
		return false;
	}
	...
	if (lastDateToApply == "") {
		alert('Please Select Last Date To Apply');
		$("#lastDateToApply").focus();
		return false;
	}
	...
	if (additionalNotes == "") {
		alert('Please Enter AdditionalNotes');
		$("#additionalNotes").focus();
		return false;
	}

	$.ajax({
		url : '/divyangjan/submitJobPost',
		data : dataString,
		type : 'POST',
		success : function(data) {
			...
			//window.location = 'jobPostingPage';
