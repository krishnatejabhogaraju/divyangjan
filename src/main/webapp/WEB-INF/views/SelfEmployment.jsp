        ...
        <div class="boxed">
            ...
            <!-- <header class="main-header">
                <div class="container">
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="active">Self Employment </li>
                    </ol>
                </div>
            </header> -->
            <header class="page-title-header-selfemp">
                <div class="container">
                    <div class="service-header-cnt">
                        <div class="service-img-icon">
                            <img src="resources/assets/img/services/banner-icon/selfemp.png" class="img-responsive" />
                        </div>
                        <div class="serive-name">Self Employment</div>
                    </div>
                </div>
            </header>
            ...
            <div class="container content-container-services">
                <section class="margin-bottom">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="right-line">Self Employment</h2>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel-group services-pannel-acc" id="accordioncc">
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-plus-link">
                                        <a data-toggle="collapse" data-parent="#accordioncc" href="#cc1" aria-expanded="false" class="collapsed">
                                            ...
                                            Information on available Self Employment Schemes
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-plus-link">
                                        <a data-toggle="collapse" data-parent="#accordioncc" href="#cc3" class="collapsed" aria-expanded="false">
                                            Providing Credit & micro finance linkages 
                                        </a>
                                    </div>
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-plus-link">
                                        <a data-toggle="collapse" data-parent="#accordioncc" href="#cc3" class="collapsed" aria-expanded="false">
                                            Advisory support to start self-employment. 
                                        </a>
                                    </div>
                                    <div id="cc3" class="panel-collapse collapse" aria-expanded="false">
                                        <div class="panel-body">
