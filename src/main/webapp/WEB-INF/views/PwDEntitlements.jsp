        ...
        <div class="boxed">
            ...
            <header class="main-header">
                <div class="container">
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="active">PwD Entitlements & Support  </li>
                    </ol>
                </div>
            </header> -->
            <header class="page-title-header-pwdensu">
                <div class="container">
                    <div class="service-header-cnt">
                        <div class="service-img-icon">
                            <img src="resources/assets/img/services/banner-icon/pwdensu.png" class="img-responsive" />
                        </div>
                        <div class="serive-name"> PwD Entitlements & Support</div>
                    </div>
                </div>
            </header>
            ...
            <div class="container content-container-services">
                <section class="margin-bottom">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="right-line">PwD Entitlements & Support </h2>
                        </div>
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-plus-link">
                                        <a data-toggle="collapse" data-parent="#accordioncc" href="#cc5" class="collapsed" aria-expanded="false">
                                            Legal assistance & case filings support.
                                        </a>
                                    </div>
