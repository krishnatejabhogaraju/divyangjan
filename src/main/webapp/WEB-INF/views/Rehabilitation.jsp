...
<!-- 
    ...
    <header class="page-title-header-habitation">
        <div class="container">
            <div class="service-header-cnt">
                <div class="service-img-icon">
                    <img src="resources/assets/img/services/banner-icon/Rehabilitation.png" class="img-responsive" />
                </div>
                <div class="serive-name">Rehabilitation</div>
            </div>
        </div>
    </header>
    ...
    <div class="container content-container-services">
        <section class="margin-bottom">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="right-line">Rehabilitation</h2>
                </div>
            </div>
            <!-- row -->
            <div class="row">
                <div class="col-md-12">
                    <div class="panel-group services-pannel-acc" id="accordioncc">
                        ...
                        Institutes providing Rehabilitation & physiotherapy for
                        PwDs
                      </a>
                            </div>
                                        ...
                                        Female
                                                    ...
                                                    <div class=" tsf-step step-3 ">
                                                        <fieldset>
                                                            ...
                                                            <form class="tsf-step-content">
                                                                <div class="form-group">
                                                                    <label for="exampleInputEmail1">Card Holder Name
                                      </label>
                                      ...
                                      <div class="col-lg-12">
                                        <div class="row">
                                          <div class="col-lg-6">
                                            <div class="checkbox">
                                              <label>
                                                <input type="checkbox" /> I read
                                                agreement and i have not any
                                                objection
                                              </label>
                                                                </div>
                                                    </div>
            ...
            <div class="panel panel-primary">
                <div class="panel-heading panel-plus-link">
                    <a data-toggle="collapse" data-parent="#accordioncc" href="#cc2" class="collapsed" aria-expanded="false">
                        List of Accessible hostels for PwDs
                      </a>
                </div>
            ...
            <div class="panel panel-primary">
                <div class="panel-heading panel-plus-link">
                    <a data-toggle="collapse" data-parent="#accordioncc" href="#cc3" class="collapsed" aria-expanded="false">
                        Information on Care & Support Centres for PwD
                      </a>
                </div>
            ...
            <div class="panel panel-primary">
                <div class="panel-heading panel-plus-link">
                    <a data-toggle="collapse" data-parent="#accordioncc" href="#cc4" class="collapsed" aria-expanded="false">
                        Information on Rehabilitation Centres
                      </a>
                </div>
