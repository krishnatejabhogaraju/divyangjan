    ...
    <div class="sb-site-container">
        <div class="boxed">
                                             ...
                                             <div class="row p-b-15">
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-6 col-megamenu">
                                                   <div class="megamenu-block">
                                                      <ul>
                                                         <li>
                                                            <a href="HealthCare.html"><i class="fa fa-caret-right"></i> Health
                                                               Care
                                                            </a>
                                                         </li>
                                                         <li>
            ...
            <header class="main-header">
                <div class="container">
                    <h1 class="page-title">Blogs & Events</h1>
                <!--                     
                    <ol class="breadcrumb pull-right">
                        <li><a href="#">Blogs & Events</a></li>
                        <li class="active">Blogs & Events</li>
                    </ol>
                 -->
                            ...
                            <article class="post animated fadeInLeft animation-delay-8">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <img src="resources/assets/img/demo/7.jpg" class="img-post img-responsive" alt="Image">
                                            </div>
                            ...
                            <article class="post animated fadeInLeft animation-delay-8">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <img src="resources/assets/img/demo/5.jpg" class="img-post img-responsive" alt="Image">
                                            </div>
                                            <div class="col-lg-6 post-content">
                                                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
                            ...
                            <article class="post animated fadeInLeft animation-delay-8">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <img src="resources/assets/img/demo/4.jpg" class="img-post img-responsive" alt="Image">
                                            </div>
                                            <div class="col-lg-6 post-content">
                                                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
                            ...
                            <article class="post animated fadeInLeft animation-delay-8">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <img src="resources/assets/img/demo/1.jpg" class="img-post img-responsive" alt="Image">
                                            </div>
                                            <div class="col-lg-6 post-content">
                                                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
                            ...
                            <article class="post animated fadeInLeft animation-delay-8">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <img src="resources/assets/img/demo/2.jpg" class="img-post img-responsive" alt="Image">
                                            </div>
                                            <div class="col-lg-6 post-content">
                                                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
                                ...
                                <div class="block animated fadeInDown animation-delay-10">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="fav">
                                            ...
                                            <ul class="media-list">
                                                <li class="media">
                                                    <a class="pull-left" href="#"><img class="media-object" src="resources/assets/img/demo/m2.jpg" width="80" height="80" alt="image"></a>
                                                ...
                                                <li class="media">
                                                    <a class="pull-left" href="#"><img class="media-object" src="resources/assets/img/demo/m9.jpg" width="80" height="80" alt="image"></a>
                                                    <div class="media-body">
                                                ...
                                                <li class="media">
                                                    <a class="pull-left" href="#"><img class="media-object" src="resources/assets/img/demo/m12.jpg" width="80" height="80" alt="image"></a>
                                                    <div class="media-body">
                                ...
                                <div class="panel panel-primary animated fadeInDown animation-delay-6">
                                    ...
                                    <div class="panel-body">
                                        <ul class="comments-sidebar">
                                            <li>
                                                <img src="resources/assets/img/demo/client.jpg" class="img-responsive" alt="Image">
                                            ...
                                            <li>
                                                <img src="resources/assets/img/demo/client2.jpg" class="img-responsive" alt="Image">
                                                <h4><a href="#">Andrew</a> in <a href="#">Lorem ipsum Fugiat elit occaecat aute nisi</a></h4>
                                                <p>Lorem ipsum Occaecat ut esse amet ut eiusmod laborum cillum voluptate do laboris dolor ut elit aliquip velit ut nulla anim ...</p>
                                            </li>
                                            <li>
                                                <img src="resources/assets/img/demo/client6.jpg" class="img-responsive" alt="Image">
                                                <h4><a href="#">Andrew</a> in <a href="#">Lorem ipsum Fugiat elit occaecat aute nisi</a></h4>
                                                <p>Lorem ipsum Occaecat ut esse amet ut eiusmod laborum cillum voluptate do laboris dolor ut elit aliquip velit ut nulla anim ...</p>
                                            </li>
                                            <li>
                                                <img src="resources/assets/img/demo/client4.jpg" class="img-responsive" alt="Image">
                                                <h4><a href="#">Andrew</a> in <a href="#">Lorem ipsum Fugiat elit occaecat aute nisi</a></h4>
                                                <p>Lorem ipsum Occaecat ut esse amet ut eiusmod laborum cillum voluptate do laboris dolor ut elit aliquip velit ut nulla anim ...</p>
                                            </li>
                                            <li>
                                                <img src="resources/assets/img/demo/client5.jpg" class="img-responsive" alt="Image">
                                                <h4><a href="#">Andrew</a> in <a href="#">Lorem ipsum Fugiat elit occaecat aute nisi</a></h4>
                                                <p>Lorem ipsum Occaecat ut esse amet ut eiusmod laborum cillum voluptate do laboris dolor ut elit aliquip velit ut nulla anim ...</p>
                                            </li>
                                        </ul>
